...
export default class App extends Component {
  ...
  _onMasterHandlerStateChange = ({ nativeEvent }) => {
    console.log(
      '[masterdrawer] STATE CHANGE ',
      State.print(nativeEvent.oldState),
      '->',
      State.print(nativeEvent.state)
    );
  };
    ...
    return (
      <View style={styles.container}>
        <PanGestureHandler
          ...
          onHandlerStateChange={this._onMasterHandlerStateChange}>
